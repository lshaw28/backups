function modelDiagramPartList(modelNumber, brandId, categoryId, diagramPageId,
                              documentId, flagMessage) {

    var urlName = "http://partsapivip.qa.ch3.s.com/pd-services/" + "models/" + modelNumber + "?brandId=" + brandId + "&productCategoryId="
...
function showPartList(data, flagMessage){

    var jsonPartList = data;
