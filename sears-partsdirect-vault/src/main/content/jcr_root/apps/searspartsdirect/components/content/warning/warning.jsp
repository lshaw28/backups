...
<spd:ResolveHazardTipWarning adhocField="warningTextEntered" choiceField="warningChosen" placeholder="NO WARNING FOUND."/>
<c:choose>
...
<cq:include path="/etc/spdAssets/globalConfig/warningPrefix" 
			resourceType="searspartsdirect/components/content/warningPrefix" />
${htwText}