...
%><div id="estimatedDeliveryModal" class="modal hide fade" role="dialog" aria-labelledby="afEstimatedDeliveryModalLabel" aria-hidden="true">
    ...
    <ul>
        <li><span class="bold">Standard: </span> <span id="standardDelivery">Monday, January 13, 2014</span></li>
        <li><span class="bold">Expedited: </span> <span id="expeditedDelivery">Friday, January 10, 2014</span></li>
        <li><span class="bold">Priority: </span> <span id="priorityDelivery">Wednesday, January 8, 2014</span></li>
    </ul>
