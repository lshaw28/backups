            ...
            <div class="row-fluid">
                ...
                <span class="span10 offset2" >
                    ...
                    <span class="span3">
                        ...
                        <p>
                            Found in diagram:<br/>
                            <a href="#.">Chassis and enclosures</a>
                        </p>


                    </span>

                    <span class="span2"> <span class="partsPrice">$<c:out value="${part.price}" /></span><br/> <c:out value="${part.availabilityStatus}" /></span>
                    <span class="span2"> <span class="Qty">Qty</span> <input type="text" class="span3" value="1"/></span>
                    <span class="span2"><input type="button" class="btn" value="Add to Cart"/></span>
