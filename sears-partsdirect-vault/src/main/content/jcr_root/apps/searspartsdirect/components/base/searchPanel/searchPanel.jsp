		...
		<div id="manualContent" class="search-content-pane">
			<ul>
				<li>
					...
					<h4><a href="<cq:text property="url1" placeholder="${mainSitePath}/partsdirect/user-manuals" default="${mainSitePath}/partsdirect/user-manuals" />" target="<cq:text property="urlTarget1" placeholder="" default="" />"><cq:text property="header1" placeholder="Get Manuals" default="Get Manuals" /><br /><span class="hidden-phone"><cq:text property="subheader1" placeholder="Find &amp; Download" default="Find &amp; Download" /></span></a></h4>
				</li>
				<li>
					<span class="icon-stack pull-left">
						<i class="icon-circle icon-stack-base"></i>
