...
<div class="row-fluid hidden-phone">
    <div class="span12 border1px accordion-heading">
    ...
    <div class="span12">
        ...
        <p>MERV 13: Less than 75% of particles 0.3 - 1.0 microns<br />
		   MERV 13: Less than 75% of particles 0.3 - 1.0 microns<br />
    ...
    <div class="span12 border1pxBottom">
		...
		<p><strong>Percentage of particles trapped</strong><br />
            85% or better of particles 3.0 - 10.0 microns</p><br/>
...
<div class="accordion first visible-phone border1px" id="parent_${uniqueId}${uniquer}">
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#parent_${uniqueId}${uniquer}" href="#${uniqueId}${uniquer}">What is a MERV rating?<i class="icon-chevron-down"></i></a>
		</div>
...
<div class="accordion visible-phone" id="parent_${uniqueId}${uniquer}">
	<div class="accordion-group">
		<div class="accordion-heading">
			<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#parent_${uniqueId}${uniquer}" href="#${uniqueId}${uniquer}">What are the MERV ratings of the filters carried by Sears PartsDirect?<i class="icon-chevron-down">&nbsp;</i> </a>
		</div>
		<div id="${uniqueId}${uniquer}" class="accordion-body collapse">
			<div class="accordion-inner">
...
<div class="row-fluid">
    <div class="span12">
       <a href="/apps/searspartsdirect/components/content/airFilterDimension/airFilterDimension.jsp">Shop Air Filters</a>
	</div>
</div>
