<%@ include file="/apps/searspartsdirect/global.jsp" %><%
	...
	%><spd:uniqueID /><%
	%>
<div><h1>What are MERV ratings for air filters? <br /> What should I buy?</h1></div>
<div class="hidden-phone">
	<div class="border1px">
		<h3>What is a MERV rating?</h3>
		<p>MERV stands for Mimium Efficiency Rating Value.It's an industry standard rating system, provided by air filter manufacturers,
	...
	<div class="paddingDivLR">
		<div class="h2_heading"><h3>What are the MERV ratings of the filters carried by Sears PartsDirect?</h3></div>
		<div>
...
<div class="accordion visible-phone">
	<div class="accordion" id="accordion2">
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
					What is a MERV rating?<i class="icon-chevron-up"></i><i class="icon-chevron-down"></i>
				</a>
			</div>
			<div id="collapseOne" class="accordion-body collapse in">
				<div class="accordion-inner">
					MERV stands for Minimum Efficiency Rating Value. It’s an industry standard rating system, provided by air filter manufacturers, designed to help choose which efficiency works best for your household. A MERV rating is a numerical value ranging from 1 (lowest efficiency) to 16 (highest efficiency) and tells the consumer how well the filter captures and holds dirt and dust.
				</div>
			</div>
		</div>
		<div class="accordion-group">
			<div class="accordion-heading">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
					What are the MERV ratings of the filters carried by Sears PartsDirect?<i class="icon-chevron-up"></i><i class="icon-chevron-down"></i>
				</a>
			</div>
...
<div class="shopAirFilterAnchor border1pxtop">
	<a href="/replacement-parts/hvac-air-filters/dimensions.html">Shop Air Filters</a>
</div>