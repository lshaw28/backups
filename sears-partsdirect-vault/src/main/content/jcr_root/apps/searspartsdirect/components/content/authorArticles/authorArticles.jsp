...
%><h4 class="articleTitle1"><a href="${url}"><c:out value="${article.title}" /></a></h4>
		<div class="span3">
			<c:if test="${not empty article.imagePath}"><a href="${url}"><spd:displayImage path="${article.imagePath}" /></a></c:if>
		</div>
		<div class="span7">
			<h4 class="articleTitle"><a href="${url}"><c:out value="${article.title}" /></a></h4>
