...
<ul>
	...
	<li class="first login_link"><a data-toggle="modal" data-target="#loginModal"><spd:getLoginStatus/></a></li>
	<li class="register"><a data-toggle="modal" data-target="#registerModal"><spd:getRegisterStatus/></a></li>
