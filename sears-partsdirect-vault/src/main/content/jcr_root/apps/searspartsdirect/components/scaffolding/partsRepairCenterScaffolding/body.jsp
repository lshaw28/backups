<%--
  ...
  Parts Repair Center Scaffolding component
    ...
    CQ.Ext.onReady(function() {
        ...
        myForm.addButton({
            ...
            handler: function() {
                ...
                var title = frm.findField("./jcr:content/jcr:title");	// We are not setting :nameHint property here. Overriding thru dialog.
