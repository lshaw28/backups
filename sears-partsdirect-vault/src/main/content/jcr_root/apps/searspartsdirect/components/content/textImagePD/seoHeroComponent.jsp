...
<%-- For Story 8078 SEO: Landing page - Hero image component  --%>
<%	
	...
	<div class="heroImageContent span8">
		...
		<div class="seoForm">
			<form id="seoModelSearchForm" method="post">
				<div class="input-append seoInput"><input type="text" id="seoModelNumberSearchInput" name="modelNumberSearchInput" maxlength="42" data-inputhelp="Enter your model number" data-inputhelpmobile="Model #" /></div>
...
<%	} else { %>
	<div class="heroImageContent row-fluid singleColumnLayout">
		...
		<div class="brandDesc"><%=properties.get("description", "") %></div>
		<div class="seoForm hidden-phone">
			<form id="seoModelSearchForm" method="post">
				<div class="input-append seoInput seoInputSingleColumn"><input type="text" id="seoModelNumberSearchInput" name="modelNumberSearchInput" maxlength="42" data-inputhelp="Enter your model number" data-inputhelpmobile="Model #" /></div>
				<button id="seoSearchModels" class="new-btn new-btn-search seoBtn"><%=properties.get("buttonText", "Find My Model ") %></button>
			</form>
		</div>
		<div class="seoForm hidden-desktop hidden-tablet">
			<form id="seoModelSearchForm" method="post">
				<div class="input-append seoInput"><input type="text" id="seoModelNumberSearchInput" name="modelNumberSearchInput" maxlength="42" data-inputhelp="Enter your model number" data-inputhelpmobile="Model #" /></div>
				<button id="seoSearchModels" class="new-btn new-btn-search seoMobBtn"><%=properties.get("buttonText", "Find My Model ") %></button>
			</form>
		</div>
	</div>
<%	} %>
