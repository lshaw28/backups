...
%><ul>
    ...
    <li class="visible-phone"><a href="tel:(800) 252-1698"><i class="icon-phone icon-2x"></i> &nbsp;Call</a></li>
    ...
    <li class="visible-phone"><a href="${mainSitePath}/partsdirect/contactus.pd"><i class="icon-envelope-alt icon-2x"></i>&nbsp;Email</a></li>
</ul>