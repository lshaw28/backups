...
%><ul>
	...
	<li class="visible-phone chatOffline"><a><i class="icon-comments-alt"></i>Chat Offline</a></li>
	<li class="visible-phone ChatNotAvailable"><a href="#"><i class="icon-comments-alt"></i>Chat</a></li>
