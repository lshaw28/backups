...
%><ul>
	...
	<li class="visible-phone chatOffline" id="pC_chat_offline_id" data-toggle="modal" data-target="#chatOfflineModal"><a><i class="icon-comments-alt"></i>Chat Offline</a></li>
