...
%><body>
    <script src="/libs/cq/ui/resources/cq-ui.js" type="text/javascript"></script><%
        ...
        ArrayList<String> categoryBasedAssets = new ArrayList(Arrays.asList("jobCode", "partType", "symptom"));
        boolean categoryBased = categoryBasedAssets.contains(currentPage.getName());
...
<script type="text/javascript">
	...
	function initCategoryForm() {
		...
		newPanel.add(new CQ.form.Selection({
			type: "select",
			name: "categorySelect",
			fieldLabel: "Category",
			boxMaxWidth: 500,
			options: <spd:getCategoryJSON/>,
			value: "select"
		}));
		myForm.add(newPanel);
		myForm.addButton({
