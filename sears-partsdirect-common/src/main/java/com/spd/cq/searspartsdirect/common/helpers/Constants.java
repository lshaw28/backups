...
public final class Constants {
	...
	public static final String PRC_PFX = ident("/part-repair-stores");
	...
	public static final String SHOPPING_CART_SIZE_COOKIE = "cartSize";
	...
	public static final String CATEGORY_SYMPTOM_TEMPLATE = ident("/apps/searspartsdirect/templates/categorySymptom");
