...
@Service(value = { javax.servlet.Servlet.class,
        ...
        PSPartDetaillServlet.class })
@Properties({
		@Property(name = "sling.servlet.extensions", value = "json"),
		@Property(name = "sling.servlet.paths", value = "/bin/searspartsdirect/search/partdetailservlet"),
		@Property(name = "sling.servlet.methods", value = "GET") })
public class PSPartDetaillServlet extends SlingSafeMethodsServlet {
	private static final Logger log = LoggerFactory
			.getLogger(PSPartDetaillServlet.class);
	...
	protected void doGet(SlingHttpServletRequest request,
		...
		if (StringUtils.isNotEmpty(flag)) {
			try {
				...
				log.error("Error occured in PSPartDetaillServlet:doGet() "
	...
	private JSONObject populatePartDetail(String PART_DETAIL_URL) throws JSONException,
        ...
        log.info("PartDetailUrlin PSPartDetaillServlet:populatePartDetail() "+partDetailUrl);
		...
		try {
			...
			if (statusCode != HttpStatus.SC_OK) {
				...
				result.put("partDetail", new String(responseBody));
			}
