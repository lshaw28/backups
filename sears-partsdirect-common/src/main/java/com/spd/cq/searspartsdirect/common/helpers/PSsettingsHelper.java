...
@Component(immediate = true, metatype = true, label = "PartsDirect Base Configuration", description = "Component interfaces with partsDirect services ")
...
public class PSsettingsHelper {
	...
	public String getPartsDirectProductAPI() {
		...
		log.info("PDDDDD:"+apiKey.toString());
		String key="";
